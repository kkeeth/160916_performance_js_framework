...
exports.__ = __;
},{}],"../src/particle-data.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.ParticleData = exports.MAX_LIFE = void 0;
...
class ParticleData {
  constructor($x, $y, $key) {
    ...
    this.displayY = Math.round(this.y); // 動的にプロパティーを追加します。
    // 速度
  ...
  update() {
    ...
    this.x += this.vx;
    this.y += this.vy; // 整数座標を保持

    this.displayX = Math.round(this.x);
    this.displayY = Math.round(this.y); // 地面の跳ね返り処理
...
var _default = {
  ...
  'exports': {
    ...
    tick() {
      ...
      for (let i = 0; i < len; i++) {
        particles.push(new _particleData.ParticleData(window.innerWidth / 2, window.innerHeight / 4, count++));
      } // 更新
...
var _appComponent = _interopRequireDefault(require("./components/app-component.riot"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

(0, _riot.component)(_appComponent.default)(document.getElementById("root"));
},{"riot":"../node_modules/riot/riot.esm.js","./components/app-component.riot":"../src/components/app-component.riot"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
