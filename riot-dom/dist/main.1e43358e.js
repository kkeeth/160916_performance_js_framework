...
function attributeExpression(node, _ref6, value, oldValue) {
  let {
    name
  } = _ref6; // is it a spread operator? {...attributes}
...
function defineComponent(_ref3) {
  let {
    ...
    componentAPI,
    name
  } = _ref3; // add the component css into the DOM
...
exports.__ = __;
},{}],"src/particle.js":[function(require,module,exports) {
"use strict";
...
class ParticleData {
  constructor($x, $y, $key) {
    ...
    this.vx = 0;
    this.vy = 0;
    this.life = 0; // 動的にプロパティーを追加します。
    // 速度

    this.vx = 30 * (Math.random() - 0.5);
    this.vy = 30 * (Math.random() - 0.5); // 寿命
  ...
  update() {
    ...
    this.vx *= 0.96;
    this.vy *= 0.96; // 速度を位置に適用

    this.x += this.vx;
    this.y += this.vy; // 地面の跳ね返り処理
...
},{}],"src/particle-obj.riot":[function(require,module,exports) {
"use strict";
    ...
    return template('<div expr6="expr6" class="particle">😊</div>', [{
      ...
      'expressions': [{
        ...
        'evaluate': function (scope) {
          return `
     top: ${scope.props.particle.y}px;
     left: ${scope.props.particle.x}px;
   `;
        }
      }]
    }]);
...
var _particleObj = _interopRequireDefault(require("./particle-obj.riot"));
...
var _default = {
  ...
  'exports': {
    ...
    /** エンターフレームイベントです。 */
    tick() {
      const particles = this.state.particles.concat(); // 発生

      const len = Number(this.state.emitOnFrame);

      for (let i = 0; i < len; i++) {
        particles.push(new _particle.ParticleData(window.innerWidth / 2, window.innerHeight / 4, this.count++));
      } // 更新


      particles.forEach((particle, index) => {
        // ランダムアップデートが無効の場合は常にアップデートする
        particle.update(); // 寿命の判定
  ...
  'template': function (template, expressionTypes, bindingTypes, getComponent) {
    return template('<div class="particle-container"><particle-obj expr31="expr31"></particle-obj></div><div class="ui"><p>Emit Particle Per 1 Frame</p><input expr32="expr32" type="range" name="emitOnFrame" min="1" max="50"/><input expr33="expr33" type="number" name="emitOnFrame" min="1" max="50"/><p expr34="expr34"><!----></p></div>', [{
      ...
      'expressions': [{
        ...
        'evaluate': function (scope) {
          return scope.state.emitOnFrame;
        }
      }, {
      ...
      'expressions': [{
        ...
        'childNodeIndex': 0,
        'evaluate': function (scope) {
          return ['現在のパーティクル数 : ', scope.state.particles.length, ' 個'].join('');
        }
      }]
    }]);
  },
...
exports.default = _default;
},{"riot":"node_modules/riot/riot.esm.js","./particle":"src/particle.js","./particle-obj.riot":"src/particle-obj.riot"}],"src/main.js":[function(require,module,exports) {
"use strict";
...
(0, _riot.component)(_app.default)(document.querySelector('app'));
},{"riot":"node_modules/riot/riot.esm.js","./app.riot":"src/app.riot"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
